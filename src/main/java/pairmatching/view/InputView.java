...
public class InputView {
	...
	private static final String INPUT_MAIN_FUNCTION_MESSAGE = "기능을 선택하세요.\n"
		+ "1. 페어 매칭\n"
		+ "2. 페어 조회\n"
		+ "3. 페어 초기화\n"
		+ "Q. 종료";

	private static final String INPUT_PAIR_MATCHING_FUNCTION_MESSAGE = "#############################################\n"
		+ "과정: 백엔드 | 프론트엔드\n"
		+ "미션:\n"
		+ "  - 레벨1: 자동차경주 | 로또 | 숫자야구게임\n"
		+ "  - 레벨2: 장바구니 | 결제 | 지하철노선도\n"
	...
	public static String getInputPairMatchingCommand() {
		System.out.println(INPUT_PAIR_MATCHING_FUNCTION_MESSAGE);
		String command = Console.readLine();
		System.out.print(System.lineSeparator());
		return command;
	}
